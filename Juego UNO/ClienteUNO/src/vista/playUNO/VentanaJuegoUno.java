...
public class VentanaJuegoUno extends JFrame {
    ...
    /**
     * Envia un mensaje al cliente como flujo de salida.
     * @param mensaje 
     */
    ...
    /**
     * Da una carta al servidor.
     * @param cartaEnMesa 
     */
    public void darCartaAServidor(int cartaEnMesa) {
        cliente.enviarDatos(String.valueOf(cartaEnMesa));
    }
    /**
    ...
    /**
     * Manda el turno al servidor por flujo de salida.
     */
    public void mandarTurno() {
        cliente.enviarDatos("turnoServidor");
    ...
    /**
     * Si el servidor le canto "UNO", le da 2 cartas al panelJugador1.
     */
    ...
    /**
     * Si el ganador es el cliente, guarda en un Archivo serializable de la clase GanadoresUNO.
     */
