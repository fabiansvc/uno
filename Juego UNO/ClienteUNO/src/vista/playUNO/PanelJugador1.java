...
public class PanelJugador1 extends JPanel {
    ...
    private int posicionIncialDeCartasMostradas;
    private int posicion;
    private int cartaEnJuego;
    ...
    public PanelJugador1(VentanaJuegoUno vju) {
        ...
        cartaEnJuego = 0;
        posicion = 0;
        posicionIncialDeCartasMostradas = 0;
    ...
    public void cuantasCartasTiene(ArrayList<Icon> cartasJugador) { // Recibe un arraylist de cartasJugador
        ...
        vju.enviarMensaje(String.valueOf("player2 " + cuantasCartas));
        if (cuantasCartas == 1) {
            vju.unaCarta(true);
            vju.estadoUNO(0);
        } else if (cuantasCartas == 0) {
            JOptionPane.showMessageDialog(null, "Ganastes");
            vju.enviarMensaje("perdioServidor");
            vju.ganadoresUno();
