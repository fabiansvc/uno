...
public class CartasTomadas {

    private final File archivo;
    private ArrayList<CartasJugador> cartasJugador;
    /**
     * Constructor de la clase CartaTomada.
     */
    public CartasTomadas() {
        archivo = new File("datos/cartasTomadas.uno");
        cartasJugador = new ArrayList();
    }
    /**
     * Guarda todas las cartas tomadas por el jugador en un archivo plano cartasTomadas.uno.
     */
    ...
    /**
     * agrega los datos del nickname, valor, color a un arraylist de tipo CartaJugador.
     * @param nickname
     * @param valor
     * @param color 
     */
    public void agregarDatos(String nickname, String valor, String color) {
        CartasJugador jugador = new CartasJugador(nickname, valor, color);
